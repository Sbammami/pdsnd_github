...
# -*- coding: utf-8 -*-
"""
__author__ = 'SADIQ MUHAMMAD <sadiq.muhammad.bammami@gmail.com>'
__homepage__ = www.beesoft.com.ng
...
def station_stats(df):
    """Displays statistics on the most popular stations with trip."""
...
def display_data(df):
    ...
    end_loc = 5
    while True:
        if view_data.lower() in  ["yes", "y"]:
            print(df.iloc[start_loc:end_loc])
            start_loc += 5
            end_loc += 5
            view_data = input("Do you wish to see the next 5 rows?: ").lower()
        else:
            # any input other than yes should terminate
            break
